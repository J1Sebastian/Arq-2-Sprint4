...
TEMPLATES = [
    {
        ...
        'DIRS': [
           os.path.join(BASE_DIR, 'historiasclinicas','templates'),
           os.path.join(BASE_DIR, 'historiasclinicas', 'templates', 'historiasclinicas')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        "PASSWORD": "isis2503",
        "HOST": "10.128.0.2",  # IP privada de la base de datos del ms
        "PORT": "5432",  # 5432
    }
}
